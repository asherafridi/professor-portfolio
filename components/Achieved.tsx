    ...
    return (
        ...
        <section className="min-h-screen w-full overflow-hidden" id="awards-section">
            <div id="done-container" className="done-container min-h-screen w-full bg-black flex">
                {/* <!-- Award  --> */}
                <div className="awards min-h-screen min-w-full bg-white px-32 py-16 flex flex-col items-center">
                ...
                {/* <!-- Publication  --> */}
                <div className="awards min-h-screen min-w-full bg-gray-100 px-32 py-16 flex flex-col items-center">
