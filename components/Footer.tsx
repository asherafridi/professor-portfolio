  ...
  return (
    ...
    <section className="h-[500px] bg-gray-100 border-t border-gray-400  px-16 flex py-12 gap-8">
        <div className="w-1/3  h-full flex flex-col  items-start">
            ...
            <Link href="" className="mt-4 px-16 py-4 bg-gray-800 text-white gap-2 flex justify-center text-lg"><i className="ri-send-plane-line"></i>Write a Message</Link>
        </div>
        <div className="w-1/3">
            <h1 className="text-5xl bebas-neue-regular text-gray-600">Quick Links</h1>
            <ul className="mt-4">
                <li className="mt-1"><Link href="/" className="text-lg hover:underline underline-offset-4">Home</Link></li>
                <li className="mt-1"><Link href="#" className="text-lg hover:underline underline-offset-4">Certificates</Link></li>
                <li className="mt-1"><Link href="#" className="text-lg hover:underline underline-offset-4">Honor & Awards</Link></li>
                <li className="mt-1"><Link href="#" className="text-lg hover:underline underline-offset-4">Publications</Link></li>
                <li className="mt-1"><Link href="#" className="text-lg hover:underline underline-offset-4">Skills</Link></li>
                <li className="mt-1"><Link href="#" className="text-lg hover:underline underline-offset-4">Student Resources</Link></li>
            </ul>
        </div>
        <div className="w-1/3">
